...
for (let i = 0; i < 4; i += 1) {
  ...
  imgDtop.src = projDB[i].imgDesktop;
  ...
  dFirstTitle.textContent = projDB[i].titleDesktop;
  ...
  const [ovMobVal1, ovMobVal2, ovMobVal3] = projDB[i].overheadMobile;
  mLiElem1.textContent = ovMobVal1;
  const mLiElem2 = document.createElement('li');
  mLiElem2.textContent = ovMobVal2;
  mLiElem2.classList.add('mobile');
  const mLiElem3 = document.createElement('li');
  mLiElem3.textContent = ovMobVal3;
  ...
  const [ovDeskVal1, ovDeskVal2, ovDeskVal3] = projDB[i].overheadDesktop;
  dLiElem1.textContent = ovDeskVal1;
  const dLiElem2 = document.createElement('li');
  dLiElem2.textContent = ovDeskVal2;
  dLiElem2.classList.add('desktop');
  const dLiElem3 = document.createElement('li');
  dLiElem3.textContent = ovDeskVal3;
  ...
  dProjectDetail.textContent = projDB[i].shortdescDesktop;
  console.log(projDB[i].shortdescDesktop);
...
for (let i = 0; i < 4; i += 1) {
  ...
  for (let i = 0; i < rightListItems.length; i += 1) {
...
closeButtons.forEach((btnClose, index) => {
  btnClose.addEventListener('click', () => {
    ...
    const target = document.getElementById(`${index + 1}-project`);
